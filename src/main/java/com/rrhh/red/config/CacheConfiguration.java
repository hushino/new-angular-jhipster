...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.rrhh.red.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.rrhh.red.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.rrhh.red.domain.User.class.getName());
            createCache(cm, com.rrhh.red.domain.Authority.class.getName());
